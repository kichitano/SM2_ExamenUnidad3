...
Podemos observar que tenemos muchos workflows ejecutandose, y eso se debe a que cada subida de archivos (permite solo 100 en la web) va ejecutando el workflow y como nuestro backend tiene mas de 100 se ejecuta por cada commit realizado. Esperamos a finalizar su ejecucion
y para corroborar al final realizaremos un re-run.
